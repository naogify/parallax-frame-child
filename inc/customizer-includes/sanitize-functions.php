 ...
 * @since Parallax Frame 0.1
 */
function parallax_frame_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Parallax Frame 0.1
 */
function parallax_frame_sanitize_custom_css( $input ) {
	if ( '' != $input  ) {
 ...
 */
function parallax_frame_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Parallax Frame 0.1
 */
function parallax_frame_sanitize_page( $input ) {
 ...
 * @since Parallax Frame 0.1
 */
function parallax_frame_sanitize_category_list( $input ) {
	if ( '' != $input  ) {
		if( in_array( 0, $input ) ) {
			return '0';
		}
 ...
 *                    the setting default.
 */
function parallax_frame_sanitize_number_range( $number, $setting ) {
 ...
 *
 * @see parallax_frame_sanitize_select()               https://developer.wordpress.org/reference/functions/parallax_frame_sanitize_select/
 ...
 */
function parallax_frame_sanitize_select( $input, $setting ) {
